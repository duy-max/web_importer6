...
class Home(WebHandler):
    ...
    def is_production_db_display(self):
        return self.expect_enabled(self.LCT.PRODUCTION_DB)
    
    def is_clone_version_visibility(self):
        return self.is_visible(self.LCT.CLONE_VERSION_BTN_PRO_DB, timeout=5)
    
    def is_delete_btn_visibility(self):
        return self.is_visible(self.LCT.DELETE_ACTION, timeout=5)
