// main.ts
// Import scenario functions (each file should export a named function)
import { loginTest } from "./api/login.test";
import { downloadTest } from "./api/download.test";
