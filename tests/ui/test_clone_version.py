...
def test_clone_version_with_valid_conditions(page, config, api):
    ...
    rd_note = clone.get_sections_pro_db_info(section="rd_note")
    release_note = clone.get_sections_pro_db_info(section="release_note")
    lib_log = clone.get_sections_pro_db_info(section="lib_log")
...
@pytest.mark.clone_dev_from_version
