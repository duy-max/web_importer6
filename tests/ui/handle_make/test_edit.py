...
def test_edit_some_field_draft_version(page, config, api):
    ...
    release_notes_expected = edit.get_sections_pro_db_info(section="release_note")
    resp, data, _ = api.run_and_wait_json(
...
def test_edit_all_fields_with_empty(page, config, api):
    ...
    rd_notes_expected = edit.get_sections_pro_db_info(section="rd_note")
    lib_log_expected = edit.get_sections_pro_db_info(section="lib_log")
    release_notes_expected = edit.get_sections_pro_db_info(section="release_note")
    resp, data, _ = api.run_and_wait_json(
